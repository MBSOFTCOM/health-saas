...
@Schema(description = "管理后台 - 摸底库测试 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ScreenPersonTestRespVO {

    @Schema(description = "主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "15872")
    @ExcelProperty("主键")
    private Long id;
    ...
    @ExcelProperty("第一人群分类（1-重点人群 2-非重点人群 4-教职工）")
    private Integer firstType;

    @Schema(description = "多人群分类（1-学生、2-老年人、4-教职工、8-密接者、16-糖尿病、32-僧尼、64-既往患者）", example = "1")
    @ExcelProperty("多人群分类（1-学生、2-老年人、4-教职工、8-密接者、16-糖尿病、32-僧尼、64-既往患者）")
