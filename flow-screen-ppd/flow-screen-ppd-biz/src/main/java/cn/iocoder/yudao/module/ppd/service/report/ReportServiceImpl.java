 ...
 */
        ...
        for (int i = 0; i < personIto.size(); i++) {
            ...
            switch (i){
                case 0 : num = reportMapper.countCtOrDrError(filmingReqVO);
                    break;
                case 1 : num = reportMapper.getCollectAndPpdErrorNum(filmingReqVO);
                    break;
                case 2 : num = reportMapper.countCollectOrPpdOrCtOrDrError(filmingReqVO);
                    break;
                case 3 : num = reportMapper.countCollectOrCtOrDrError(filmingReqVO);
                    break;
            }
            resultNum+=num;
        }
...
//        1.2.4 查找教职工
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                switch (i){
                    case 0 : num = reportMapper.getCollectAndPpdErrorNum(filmingReqVO);
                        break;
                    case 1 : num = reportMapper.countCollectOrPpdOrCtOrDrError(filmingReqVO);
                        break;
                    case 2 : num = reportMapper.countCtOrDrError(filmingReqVO);
                        break;
                    case 3 : num = reportMapper.countCollectOrCtOrDrError(filmingReqVO);
                        break;
                }
