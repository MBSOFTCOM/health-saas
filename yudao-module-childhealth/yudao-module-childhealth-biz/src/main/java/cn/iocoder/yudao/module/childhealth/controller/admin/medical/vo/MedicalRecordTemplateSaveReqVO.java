...
@Schema(description = "管理后台 - 病历模板新增/修改 Request VO")
@Data
public class MedicalRecordTemplateSaveReqVO {

    @Schema(description = "主键ID", example = "1")
    private Long id;

    @Schema(description = "模板编码", requiredMode = Schema.RequiredMode.REQUIRED, example = "EYE-01M")
    @NotBlank(message = "模板编码不能为空")
    private String templateCode;

    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "满月眼保健病历模板")
    ...
    @Schema(description = "所依据的国家规范", example = "《0-6岁儿童眼保健及视力检查服务规范（2021年版）》")
    private String normVersion;

    @Schema(description = "模板说明")
    private String description;

    @Schema(description = "模板内容结构化JSON（schema + defaultValues）")
