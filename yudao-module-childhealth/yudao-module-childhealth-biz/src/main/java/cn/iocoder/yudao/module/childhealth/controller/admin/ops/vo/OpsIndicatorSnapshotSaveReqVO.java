...
/**
 * 运营指标快照新增/修改 Request VO
 *
 * 创建日期: 2026-07-20
 */
@Schema(description = "管理后台 - 运营指标快照新增/修改 Request VO")
@Data
public class OpsIndicatorSnapshotSaveReqVO {

    @Schema(description = "主键ID", example = "1")
    private Long id;

    @Schema(description = "快照日期", requiredMode = Schema.RequiredMode.REQUIRED, example = "2026-07-20")
