...
/**
 * 报告模板配置新增/修改 Request VO
 *
 * 创建日期: 2026-07-20
 */
@Schema(description = "管理后台 - 报告模板配置新增/修改 Request VO")
@Data
public class ReportTemplateConfigSaveReqVO {

    @Schema(description = "主键ID", example = "1")
    private Long id;

    @Schema(description = "模板编码", requiredMode = Schema.RequiredMode.REQUIRED, example = "STUDENT_REPORT_V1")
    private String templateCode;

    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "学生个人五健筛查报告")
    private String templateName;

    @Schema(description = "报告类型 1学生个人 2学校汇总 3年级 4区域监管", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
