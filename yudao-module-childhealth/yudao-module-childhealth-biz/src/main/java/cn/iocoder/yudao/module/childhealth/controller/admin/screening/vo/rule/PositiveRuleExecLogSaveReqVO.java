...
/**
 * 阳性规则执行日志新增/修改 Request VO
 *
 * 创建日期: 2026-07-20
 */
@Schema(description = "管理后台 - 阳性规则执行日志新增/修改 Request VO")
@Data
public class PositiveRuleExecLogSaveReqVO {

    @Schema(description = "主键ID", example = "1")
    private Long id;

    @Schema(description = "规则ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "100")
    private Long ruleId;

    @Schema(description = "筛查记录ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "200")
    ...
    @Schema(description = "命中时间", requiredMode = Schema.RequiredMode.REQUIRED)
