<template>
	<view class="mine-container" :style="{ height: `${windowHeight}px` }">
		...
		<view class="list-main">
			<view class="main-1 parent-entry" @click="toParentHome">
				<view class="main-1-l">
					<view class="parent-icon">家长</view>
					<view>家长健康服务</view>
				</view>
				<view class="iconfont icon-right"></view>
			</view>
...
export default {
	...
	methods: {
		...
		toParentHome(){
			this.$tab.navigateTo('/pages/parent/index');
		},
		handleToInfo() {
...
.mine-container {
	...
	.list-main{
		...
		.parent-entry{
			background: linear-gradient(135deg, rgba(36, 93, 209, 0.08), rgba(80, 104, 242, 0.08));
			.parent-icon{
				width: 40px;
				height: 40px;
				border-radius: 8px;
