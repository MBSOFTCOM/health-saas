  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="试剂id" prop="reagentId">
        <el-input v-model="formData.reagentId" placeholder="请输入试剂id" />
      </el-form-item>
      <el-form-item label="试剂名称" prop="reagentName">
        <el-input v-model="formData.reagentName" placeholder="请输入试剂名称" />
      </el-form-item>
      <el-form-item label="试剂类型" prop="reagentType">
        <el-radio-group v-model="formData.reagentType">
          <el-radio label="1">请选择字典生成</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="消耗序位" prop="consumeOrder">
        <el-radio-group v-model="formData.consumeOrder">
          <el-radio label="1">请选择字典生成</el-radio>
        </el-radio-group>
      </el-form-item>
